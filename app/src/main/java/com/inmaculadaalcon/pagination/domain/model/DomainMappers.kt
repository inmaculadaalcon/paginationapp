package com.inmaculadaalcon.pagination.domain.model

import com.inmaculadaalcon.pagination.R
import com.inmaculadaalcon.pagination.data.api.model.*
...
fun ConfigurationDto.toDomain(): Configuration {
  return Configuration(images.toDomain(), changeKeys)
}

fun ImagesDto.toDomain(): Images {
  return Images(baseUrl, secureBaseUrl)
}