package com.inmaculadaalcon.pagination.data.api.extensions

import arrow.core.Either
import com.inmaculadaalcon.pagination.data.api.error.Server403ApiException
import com.inmaculadaalcon.pagination.data.api.error.Server404ApiException
import com.inmaculadaalcon.pagination.data.api.error.Server500ApiException
import com.inmaculadaalcon.pagination.data.api.error.ServerConnectionApiException
...
fun Exception.apiException(): DomainError =
  when {
    ...
    this is com.inmaculadaalcon.pagination.data.api.error.ServerConnectionApiException -> DomainError.NoInternetError
    this is com.inmaculadaalcon.pagination.data.api.error.Server500ApiException -> DomainError.GenericDomainError
    this is com.inmaculadaalcon.pagination.data.api.error.Server404ApiException -> DomainError.GenericDomainError
    this is com.inmaculadaalcon.pagination.data.api.error.Server403ApiException -> DomainError.ServerForbiddenDomainError
    this is com.inmaculadaalcon.pagination.data.api.error.Server403ApiException -> DomainError.ServerForbiddenDomainError
